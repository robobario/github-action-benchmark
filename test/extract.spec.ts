...
describe('extractResult()', function () {
    ...
    it('collects the commit information from specified ref via REST API as fallback when githubToken and commitRef provided', async function () {
        dummyGitHubContext.payload = {};
        dummyCommitData = {
            author: {
